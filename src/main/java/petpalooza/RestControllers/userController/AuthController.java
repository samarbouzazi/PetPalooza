...
//                signUpRequest.getAddress(), signUpRequest.getOccupatio());
//
...
//                        break;
//                    case "assoc":
//                        Role assocRole = roleRepository.findByRoleName(ERole.ROLE_ASSOSITION)
//                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
//                        roles.add(assocRole);
//
//                        break;
//                    case "vet":
//                        Role vetRole = roleRepository.findByRoleName(ERole.ROLE_VETERNIARY)
//                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
//                        roles.add(vetRole);
//
//                        break;
